...
BEGIN_MESSAGE_MAP(ScreenCapTestApp, CWinAppEx)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// ScreenCapTestApp construction

ScreenCapTestApp::ScreenCapTestApp()
{
...
// The one and only ScreenCapTestApp object

ScreenCapTestApp theApp;


// ScreenCapTestApp initialization

BOOL ScreenCapTestApp::InitInstance()
{
